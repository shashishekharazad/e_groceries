...
<head>
    ...
    <title>Santosh Vegetable Store - Blog</title>
...
<div class="brand">Santosh Vegetable Store</div>
    <div class="address-bar">Tatarpur | Alwar Bypass, Rajsthan 301707 | 81155 01642</div>
        ...
        <div class="row">
            <div class="box">
				...
				<h2 class="text-center">Welcome <?php echo $fname; echo " "; echo $lname; ?> - <a href="logout.php">Logout</a></h2>
                    ...
                    <hr>
                    <h2 class="intro-text text-center">Santosh Vegetable Store
                        <strong>blog</strong>
                    </h2>
                    <hr>
                </div>
	  ...
	  <div class="modal-dialog">
		...
		<div class="modal-content">
		  <div class="modal-header">
			...
			<h4 class="modal-title">Leafy Green</h4>
		  </div>
	...
	<div id="myModal2" class="modal fade" role="dialog">
	  <div class="modal-dialog">
		...
		<div class="modal-content">
		  <div class="modal-header">
			<button type="button" class="close" data-dismiss="modal">&times;</button>
			<h4 class="modal-title">Edible Plnt Sterm</h4>
		  </div>
		  <div class="modal-body">
			<p>Sample Text.</p>
		  </div>
	...
	<div id="myModal3" class="modal fade" role="dialog">
	  <div class="modal-dialog">
		...
		<div class="modal-content">
		  <div class="modal-header">
			<button type="button" class="close" data-dismiss="modal">&times;</button>
			<h4 class="modal-title">Berries</h4>
		  </div>
		  <div class="modal-body">
			<p>Sample Text.</p>
		  </div>
    ...
    <footer>
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <p>Copyright &copy; Santosh Vegetable Store 2019</p>
                </div>
            </div>
        </div>
    </footer>
