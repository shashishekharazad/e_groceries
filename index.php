...
<head>
    ...
    <title>Santosh Vegetable Store - Home</title>
        ...
        <div class="row">
            <div class="box">
                <div class="col-lg-12 text-center">
                    ...
                    <h1 class="brand-name">Santosh Vegetable Store</h1>
                    <hr class="tagline-divider">
                    <h2>
                        <small>By
                            <strong>Santosh Groceries</strong>
                        </small>
                    </h2>
                </div>
            </div>
            ...
            <div class="box">
                <div class="col-lg-12">
                    ...
                    <h2 class="intro-text text-center">Introduction
                        <strong>Santosh Vegetable Store</strong>
                    </h2>
                    <hr>
